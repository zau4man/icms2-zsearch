...
function install_package() {
    ...
    //обновление
    $core->db->query("UPDATE `{#}controllers` SET `version` = '1.0.2' WHERE `name` = 'zsearch';");
    $core->db->query("UPDATE `{#}widgets` SET `version` = '1.0.2' WHERE `controller` = 'zsearch' AND `name` = 'zsearch';");
